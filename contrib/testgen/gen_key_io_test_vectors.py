...
bech32_templates = [
  ...
  ('part',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('part',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('part',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('part',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tpart',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpart',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpart',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpart',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tpart',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpart',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpart',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpart',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rpart',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rpart',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rpart',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rpart', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tpart',   17, 32, Encoding.BECH32M, False, False, False),
  ('rpart',  3,  1, Encoding.BECH32M, False, False, False),
  ('part',   15, 41, Encoding.BECH32M, False, False, False),
  ('tpart',    0, 16, Encoding.BECH32,  False, False, False),
  ('rpart',  0, 32, Encoding.BECH32,  True,  False, False),
  ('part',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tpart',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rpart',  0, 20, Encoding.BECH32,  False, False, True),
  ('part',    0, 20, Encoding.BECH32M, False, False, False),
  ('tpart',    0, 32, Encoding.BECH32M, False, False, False),
  ('rpart',  0, 20, Encoding.BECH32M, False, False, False),
  ('part',    1, 32, Encoding.BECH32,  False, False, False),
  ('tpart',    2, 16, Encoding.BECH32,  False, False, False),
  ('rpart', 16, 20, Encoding.BECH32,  False, False, False),
]
