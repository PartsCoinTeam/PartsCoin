...
"""Verify that starting partscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start partscoin with -h for help text")
        ...
        self.log.info("Start partscoin with -version for version information")
        ...
        self.log.info("Start partscoind with -fakearg to make sure it does not start")
