# Support for Output Descriptors in PartsCoin Core

Since PartsCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `part1...` for mainnet or `tpart1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing PartsCoin Core wallets, a convenience function `combo` is
