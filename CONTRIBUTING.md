Contributing to PartsCoin Core
============================

The PartsCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the PartsCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/partscoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to partscoin-qt
...
The following applies to code changes to the PartsCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall PartsCoin
Network Protocol consensus changes.

Whether a pull request is merged into PartsCoin Core rests with the project merge
...
Patches that change PartsCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the PartsCoin consensus, it must have been
...
The project leader is the release manager for each PartsCoin Core release.
