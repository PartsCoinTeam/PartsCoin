...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " partscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  partscoin-tx [options] <hex-tx> [commands]  Update hex-encoded partscoin transaction\n" +
            "or:     partscoin-tx [options] -create [commands]   Create hex-encoded partscoin transaction\n" +
            "\n";
