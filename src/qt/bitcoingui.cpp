...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PartsCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and partscoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PartsCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PartsCoin addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file..."), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed PartsCoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from clipboard..."), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed PartsCoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a partscoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible PartsCoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to PartsCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
