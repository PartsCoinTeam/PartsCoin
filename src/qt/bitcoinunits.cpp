...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString("µPART");
    case SAT: return QString("PARTS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("PartsCoins");
    case mBTC: return QString("Milli-PartsCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-PartsCoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT: return QString("PARTS (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
