...
Modular library for supporting PartsCoin's implementation of the MWEB (Mimblewimble Extension Block). 
...
### crypto/
Crypto libraries not provided by partscoin or secp256k1-zkp.
...
While boost\:\:filesystem is already pulled in by partscoin, I was uncomfortable with its API and its handling of unicode conversions.
...
and just replace the more-limited secp256k1 dependency that's already included in PartsCoin.
